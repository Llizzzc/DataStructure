...
public class AllPathImprovement2 {
    ...
    public static void main(String[] args) {
        AllPathImprovement2 pathImprovement = new AllPathImprovement2(new UndirectedAdjSet("g.txt"),  0, 6);
        System.out.println("0 -> 6: " + pathImprovement.path());
        pathImprovement = new AllPathImprovement2(new UndirectedAdjSet("g.txt"), 1, 4);
        System.out.println("1 -> 4: " + pathImprovement.path());
        pathImprovement = new AllPathImprovement2(new UndirectedAdjSet("g.txt"), 3, 6);
