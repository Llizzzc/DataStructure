...
public class HamiltonLoopImprovement {
    ...
    public static void main(String[] args) {
        HamiltonLoopImprovement hamiltonLoopImprovement = new HamiltonLoopImprovement(new UndirectedAdjSet("g9.txt"));
        System.out.println(hamiltonLoopImprovement.path());
        hamiltonLoopImprovement = new HamiltonLoopImprovement(new UndirectedAdjSet("g10.txt"));
        System.out.println(hamiltonLoopImprovement.path());
    }
}