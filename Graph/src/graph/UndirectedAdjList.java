...
public class UndirectedAdjList implements UndirectedGraph {
     ...
     */
    public UndirectedAdjList(String filename) {
    ...
    public static void main(String[] args) {
        UndirectedAdjList adjList = new UndirectedAdjList("g.txt");
