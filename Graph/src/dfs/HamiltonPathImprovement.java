...
public class HamiltonPathImprovement {
    ...
    public static void main(String[] args) {
        HamiltonPathImprovement hamiltonPathImprovement = new HamiltonPathImprovement(new AdjSet("g11.txt"), 0);
        System.out.println(hamiltonPathImprovement.path());
        hamiltonPathImprovement = new HamiltonPathImprovement(new AdjSet("g11.txt"), 1);
        System.out.println(hamiltonPathImprovement.path());
    }
}